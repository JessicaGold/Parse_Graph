...
majority of edges are within a cluster rather than between clusters.

The algorithm takes a group of vertices and splits the group into two,
then continues splitting recursively until there is nothing to be gained by further splits.
...
The input to the program should be the name of a binary file of the following format:
...
The program needs two arguments: the name of the input file, the desired name of the output file.
